...
[СКРИНШОТ: Доска с несколькими карточками моделей, парой референс-картинок и текстовой заметкой]
...
| **Меню карточки** | Все настройки конкретной модели. Открывается кликом ПКМ по карточке.                                                      |
...
[СКРИНШОТ: Пустая доска после первого запуска, подписаны плашка File и кнопка ?]
...
1. **Закиньте модель.** Перетащите `.glb`, `.fbx`, `.obj` или `.stl` файлы из проводника на доску. Появится карточки с 3D моделями. 
...
[СКРИНШОТ: Карточка с моделью, рядом открытое меню карточки]
...
[СКРИНШОТ: Слева меню карточки, справа меню доски, у обоих подписана булавка]
...
[СКРИНШОТ: Одна модель в четырёх видах: Clay, PBR, Normals, Clay+Wireframe]
...
[СКРИНШОТ: Меню доски с тремя панелями Studio Lights; рядом карточка с включённым RT Shadow]
...
[СКРИНШОТ: Секция Texture Slots: три слота смотрят в один ORM-файл с каналами R/G/B, Normal выключен чекбоксом]
...
Если у модели несколько UV-каналов (лайтмап, detail-слой), они отображаются в виде вкладок.
